...
public interface RateLimiter {
     ...
     */
    boolean throttle(Code code) throws NoSuchMethodException;
     ...
     * <p
     */
    boolean acquire() throws NoSuchMethodException;
     ...
     */
    boolean acquire(int permits) throws NoSuchMethodException;
